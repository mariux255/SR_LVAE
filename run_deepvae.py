...
parser.add_argument('--model_type', default='lvae', help='model type (vae | lvae | biva)')
...
valid_loader = DataLoader(valid_dataset, batch_size=opt.bs, shuffle=True, pin_memory=False,
                          num_workers=opt.num_workers)
test_loader = DataLoader(test_dataset, batch_size=opt.bs, shuffle=True, pin_memory=False,
                         num_workers=opt.num_workers)
